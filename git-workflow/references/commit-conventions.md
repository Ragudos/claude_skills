...
Signed-off-by: Name <[email@example.com](mailto:email@example.com)>

# Include below only if co-authors exist:
Co-authored-by: Name1 <[name1@example.com](mailto:name1@example.com)>
Co-authored-by: Name2 <[name2@example.com](mailto:name2@example.com)>
```
...
Reviewed-by: John Doe <johndoe@example.com>
Refs: #456
...
Stripe v2 is being deprecated in Q3 2026. This migrates all
payment processing to the v3 SDK with improved error handling
and webhook signature verification.

BREAKING CHANGE: `chargeUser()` replaced by `createPaymentIntent()`
Closes: #312
Ticket: PAY-88
Committed-on: 2026-04-26
Signed-off-by: Juan dela Cruz <juan@example.com>
Reviewed-by: Maria Santos <maria@example.com>
Co-authored-by: Claude <claude@anthropic.com>
```

### Scope Guidelines

Scopes should be consistent accross the project:
...
#   ci       (CI configuration)
#   build    (build system changes)
#   revert   (revert committed changes)
# --------------------
EOF
...
# Committed-on: YYYY-MM-DD
# Signed-off-by: Name <[email@example.com](mailto:email@example.com)>
# Reviewed-by: Name <[email@example.com](mailto:email@example.com)>
# Co-authored-by: Name1 <[name1@example.com](mailto:name1@example.com)>
